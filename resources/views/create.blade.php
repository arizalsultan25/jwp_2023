            ...
            <form action="{{ route('barang.store') }}" method="post">
                <div class="card mb-4">
                    <div class="card-title">
                        <h5 class="card-header">Form input barang</h5>
                    </div>
                    <div class="card-body">
                        @csrf
                        <div class="mb-3">
                            ...
                            is-invalid
                            @enderror" value="{{ old('kode_barang') }}" name="kode_barang" id="kode_barang" maxlength="16"
                                minlength="8" placeholder="Kode barang">
                            @error('kode_barang')
                        ...
                        <div class="mb-3">
                            ...
                            is-invalid
                            @enderror" value="{{ old('nama_barang') }}" name="nama_barang" id="nama_barang" placeholder="Nama barang">
                            @error('nama_barang')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            is-invalid
                            @enderror" value="{{ old('jenis') }}" name="jenis" id="jenis" placeholder="Jenis">
                            @error('jenis')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            is-invalid
                            @enderror" value="{{ old('satuan') }}" name="satuan" id="satuan" placeholder="Satuan barang">
                            @error('satuan')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            is-invalid
                            @enderror" value="{{ old('merk') }}" name="merk" id="merk" placeholder="Merk barang">
                            @error('merk')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            is-invalid
                            @enderror" value="{{ old('produsen') }}" name="produsen" id="produsen" placeholder="Nama Produsen">
                            @error('produsen')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            is-invalid
                            @enderror" value="{{ old('harga_beli') }}" name="harga_beli" id="harga_beli" placeholder="Harga beli">
                            @error('harga_beli')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
